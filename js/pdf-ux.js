$(document).ready(function () {
  try {
    ...
    let zipLevel = "";
    let baseUrlSection = "/ja-jp/announcements/pdfs/sidebar/";
    let baseUrlPages = "/ja-jp/announcements/pdfs/pages/";
    let zipFilename = "";
    let zipFileSize = 0;
    zipLevel = zipLevel !== ""?zipLevel:1;
    zipFilename = zipFilename !== ''?zipFilename:"announcements.ja-jp.zip";
